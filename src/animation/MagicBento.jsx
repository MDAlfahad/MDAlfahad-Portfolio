...
const DEFAULT_GLOW_COLOR = "102,187,106";
const MOBILE_BREAKPOINT = 768;

// --- CHANGE 1: Added a 'link' property to each card object ---
// TODO: Replace the "#" with your actual links.
const cardData = [
  {
    backgroundImage: `url(${FigmaDesign})`,
    title: "UI Design",
  ...
  },
  {
    ...
    description: "Blender community a 3D Modling software",
    label: "Blender Website",
    link: "https://mdalfahad.github.io/Blender-clone/",
  },
  {
    backgroundImage: `url(${AppleWebsite})`,
    title: "Website",
  ...
  },
  {
    ...
    label: "Chaupati-Website",
    link: "https://mdalfahad.github.io/Smart-chopati/",
  },
];
...
const ParticleCard = ({
  ...
  link, // --- CHANGE 2: Added 'link' to props ---
}) => {
  ...
  useEffect(() => {
    ...
    // --- CHANGE 3: Modified handleClick to open the link ---
    const handleClick = (e) => {
      if (link) {
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          ...
          if (enableStars) {
            return (
              <ParticleCard
                ...
                link={card.link} // --- CHANGE 4: Pass the link to ParticleCard ---
              >
          ...
          // Fallback rendering for when stars are disabled
          return (
            <div
              key={index}
              {...cardProps}
              ref={(el) => {
                ...
                // --- CHANGE 5: Updated this handleClick as well ---
                const handleClick = (e) => {
                  if (card.link) {
