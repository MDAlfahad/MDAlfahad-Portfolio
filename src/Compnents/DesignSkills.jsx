...
const servicesData = [
  ...
  { icon: <FaReact size={30} />, title: "Frontend Development" },
          ...
          <div className="lg:w-1/2 w-full">
            <div className="flex items-center mb-6">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800 leading-tight pr-4">
                What My Design <br />{" "}
                <span className="text-green-400">Skills Included</span>
              </h2>
            ...
            <p className="text-gray-600 mb-8 max-w-md">
              ...
              tell, every brand we build, and every interaction we create must
